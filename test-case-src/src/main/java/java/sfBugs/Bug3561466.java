...
public class Bug3561466 {
    ...
    static class PrivateFunctions {
        ...
        public static Call<List<?>, List<String>> calculateSymbolicValues(
                Metric<?, String> domainLabelMetric) {
            ReflectedCall<List<?>, List<String>> result = new ReflectedCall<List<?>, List<String>>(
