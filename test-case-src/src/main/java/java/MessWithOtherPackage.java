...
import java.messWithMe.DumbPublicClass;
import java.messWithMe.UnprotectedClass;
...
public class MessWithOtherPackage extends DumbPublicClass // Hoohoo!
{
    public static void main(String[] args) {
        ...
        /*
         * Although the CreditCardNumbers array is package, and the interface it
         * is in is also package, there was a public class that implemented that
